...
async function handleEvent(event) {
  ...
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        // [3.2] คำสั่งควบคุมพฤติกรรมบอท (เปลี่ยนนิสัยได้ตรงนี้)
        systemInstruction: "คุณคือเพื่อนสนิทในกลุ่มแชท ตอบคำถามอย่างเป็นกันเอง สนุกสนาน กวนๆ เล็กน้อย ใช้ภาษาวัยรุ่นไทย ไม่พูดจาเป็นทางการเหมือนหุ่นยนต์ ตอบสั้นๆ กระชับ เน้นฮาและได้สาระครบรส"
      }
    });
